...
<img src="{{site.baseurl}}/assets/img/drone_propellordir.png" alt="drone flight path" style="width:50%;" />
...
![Perception Calibration]({{site.baseurl}}/assets/img/drone_cal.png){: style="width:70%;" }
...
![Projection and Mapping Visualization]({{site.baseurl}}/assets/img/drone_miniexample.png){: style="width:70%;" }
...
<img src="{{site.baseurl}}/assets/img/drone_planning.png" alt="drone" style="width:40%;" />
<img src="{{site.baseurl}}/assets/img/drone_grid.png" alt="drone" style="width:40%;" />

- **Autonomous Flight:**
<video width="90%" controls> <source src="{{site.baseurl}}/assets/img/drone_lawnmover.webm" type="video/webm"> Your browser does not support the video tag. </video>
